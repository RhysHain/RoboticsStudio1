...
# Parameters
num_pine_trees = 200          # Number of pine trees to generate
min_coord = -60              # Min x/y for trees and red box
max_coord = 60               # Max x/y
z_tree = 0
roll = pitch = yaw = 0
z_red_box = 0.5

# Output path relative to the script
output_dir = os.path.join("Simulation Files", "41068_ignition_bringup_with_drone", 
                          "41068_ignition_bringup", "worlds")
os.makedirs(output_dir, exist_ok=True)
output_file = os.path.join(output_dir, "generated_world.sdf")

# Base SDF parts (everything before pine forest)
